...
exports.Cashfree = exports.PayoutWebhookEvent = exports.CreateTransferRequestBeneficiaryDetailsBeneficiaryInstrumentDetailsCardDetailsCardNetworkTypeEnum = exports.CreateTransferRequestTransferModeEnum = exports.CreateBatchTransferRequestTransfersInnerTransferModeEnum = exports.BeneficiaryBeneficiaryStatusEnum = void 0;
...
exports.CreateBatchTransferRequestTransfersInnerTransferModeEnum = {
...
exports.CreateTransferRequestTransferModeEnum = {
    BANKTRANSFER: 'banktransfer',
    IMPS: 'imps',
    NEFT: 'neft',
    RTGS: 'rtgs',
...
exports.CreateTransferRequestBeneficiaryDetailsBeneficiaryInstrumentDetailsCardDetailsCardNetworkTypeEnum = {
    VISA: 'VISA',
...
const BeneficiaryV2ApiAxiosParamCreator = function (configuration) {
    return {
        ...
        payoutCreateBeneficiary: (x_api_version, x_request_id, CreateBeneficiaryRequest, options = {}) => __awaiter(this, void 0, void 0, function* () {
            ...
            (0, common_1.assertParamExists)('payoutCreateBeneficiary', 'x_api_version', x_api_version);
            ...
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(CreateBeneficiaryRequest, localVarRequestOptions, configuration);
            return {
        ...
        payoutDeleteBeneficiary: (x_api_version, x_request_id, beneficiary_id, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'x_api_version' is not null or undefined
            (0, common_1.assertParamExists)('payoutDeleteBeneficiary', 'x_api_version', x_api_version);
            const localVarPath = `/beneficiary`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            var url = "https://sandbox.cashfree.com/payout";
            if (Cashfree.XEnvironment == configuration_1.CFEnvironment.PRODUCTION) {
        ...
        payoutFetchBeneficiary: (x_api_version, x_request_id, beneficiary_id, bank_account_number, bank_ifsc, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'x_api_version' is not null or undefined
            (0, common_1.assertParamExists)('payoutFetchBeneficiary', 'x_api_version', x_api_version);
            const localVarPath = `/beneficiary`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            var url = "https://sandbox.cashfree.com/payout";
            if (Cashfree.XEnvironment == configuration_1.CFEnvironment.PRODUCTION) {
...
const TransfersV2ApiAxiosParamCreator = function (configuration) {
    return {
        ...
        payoutFetchBatchTransfer: (x_api_version, x_request_id, cf_batch_transfer_id, batch_transfer_id, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'x_api_version' is not null or undefined
            (0, common_1.assertParamExists)('payoutFetchBatchTransfer', 'x_api_version', x_api_version);
        ...
        payoutFetchTransfer: (x_api_version, x_request_id, cf_transfer_id, transfer_id, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'x_api_version' is not null or undefined
            (0, common_1.assertParamExists)('payoutFetchTransfer', 'x_api_version', x_api_version);
        ...
        payoutInitiateBatchTransfer: (x_api_version, x_request_id, CreateBatchTransferRequest, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'x_api_version' is not null or undefined
            (0, common_1.assertParamExists)('payoutInitiateBatchTransfer', 'x_api_version', x_api_version);
            const localVarPath = `/transfers/batch`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            var url = "https://sandbox.cashfree.com/payout";
            if (Cashfree.XEnvironment == configuration_1.CFEnvironment.PRODUCTION) {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = Object.assign(Object.assign(Object.assign({}, localVarHeaderParameter), headersFromBaseOptions), options.headers);
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(CreateBatchTransferRequest, localVarRequestOptions, configuration);
            return {
                url: (0, common_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
        ...
        payoutInitiateTransfer: (x_api_version, x_request_id, CreateTransferRequest, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'x_api_version' is not null or undefined
            (0, common_1.assertParamExists)('payoutInitiateTransfer', 'x_api_version', x_api_version);
            const localVarPath = `/transfers`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            var url = "https://sandbox.cashfree.com/payout";
            if (Cashfree.XEnvironment == configuration_1.CFEnvironment.PRODUCTION) {
...
exports.PayoutWebhookEvent = PayoutWebhookEvent;
class Cashfree {
    /**
